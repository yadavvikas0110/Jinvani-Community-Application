...
class ShareFeedbackScreen extends ConsumerStatefulWidget {
  const ShareFeedbackScreen({super.key});

  @override
  ConsumerState<ShareFeedbackScreen> createState() =>
      _ShareFeedbackScreenState();
}

class _ShareFeedbackScreenState extends ConsumerState<ShareFeedbackScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (!mounted) return;
    if (fb != null) {
      context.pushReplacement('/support/feedback/submitted');
    } else {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Help us build a better experience for you',
                        style: TextStyle(
                          fontSize: 12,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _BorderedField(
                              ...
                              hint:
                                  'Describe your feedback in detail so we can help you faster...',
                              maxLines: 6,
                              minLines: 5,
