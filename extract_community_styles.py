...
try:
    ...
    flows_to_check = ["Directory Flow", "Family Tree Flow"]
    ...
    with open('community_figma_summary.json', 'w') as out:
        json.dump(summary, out, indent=2)
    print("Community summary generated in community_figma_summary.json")
